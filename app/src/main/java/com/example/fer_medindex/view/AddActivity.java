...
public class AddActivity extends AppCompatActivity {
    ...
    private EditText editTextAddFullName, editTextAddEmail,
            editTextAddDoB, editTextAddMobile, editTextAddCMND, editAddAddress, editTextAddTinhTrangBenh;
    private Button btnAddPatients, btnExit;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageProfile.setOnClickListener(view -> dialogChooseImage());
        btnAddPatients.setOnClickListener(v -> {
            int selectedGenderId = radioGroupRegisterGender.getCheckedRadioButtonId();
            radioButtonRegisterGenderSelected = findViewById(selectedGenderId);
            textFullName = editTextAddFullName.getText().toString();
            textEmail = editTextAddEmail.getText().toString();
            textDoB = editTextAddDoB.getText().toString();
            textMobile = editTextAddMobile.getText().toString();
            textCMND = editTextAddCMND.getText().toString();
            textAddress = editAddAddress.getText().toString();
            ...
            if (TextUtils.isEmpty(textFullName)) {
                ...
                Toast.makeText(AddActivity.this, "Vui lòng nhập ngày sinh của bạn", Toast.LENGTH_LONG).show();
                editTextAddDoB.setError("Bắt buộc nhập ngày sinh");
                editTextAddDoB.requestFocus();
            } else if (radioGroupRegisterGender.getCheckedRadioButtonId() == -1) {
                Toast.makeText(AddActivity.this, "Vui lòng chọn giới tính của bạn", Toast.LENGTH_LONG).show();
                radioButtonRegisterGenderSelected.setError("Bắt buộc phải chọn giới tính");
                radioButtonRegisterGenderSelected.requestFocus();
            } else if (TextUtils.isEmpty(textMobile)) {
                Toast.makeText(AddActivity.this, "Vui lòng nhập số điện thoại của bạn ", Toast.LENGTH_LONG).show();
                editTextAddMobile.setError("Bắt buộc nhập số điện thoại");
                editTextAddMobile.requestFocus();
            } else if (textMobile.length() != 10) {
                Toast.makeText(AddActivity.this, "Vui lòng nhập số điện thoại của bạn ", Toast.LENGTH_LONG).show();
                editTextAddMobile.setError("Điện thoại di động phải có 10 chữ số");
                editTextAddMobile.requestFocus();
            } else if (!mobileMatcher.find()) {
                Toast.makeText(AddActivity.this, "Vui lòng nhập số điện thoại của bạn ", Toast.LENGTH_LONG).show();
                editTextAddMobile.setError("Điện thoại di động không hợp lệ");
                editTextAddMobile.requestFocus();
            } else if (TextUtils.isEmpty((textCMND))) {
                Toast.makeText(AddActivity.this, "Vui lòng nhập CMND của bạn", Toast.LENGTH_LONG).show();
                editTextAddEmail.setError("Bắt buộc nhập CMND");
                editTextAddEmail.requestFocus();
            } else if (TextUtils.isEmpty((textAddress))) {
                Toast.makeText(AddActivity.this, "Vui lòng nhập địa chỉ của bạn", Toast.LENGTH_LONG).show();
                editTextAddEmail.setError("Bắt buộc nhập địa chỉ");
                editTextAddEmail.requestFocus();
                ...
                Toast.makeText(AddActivity.this, "Vui lòng chọn tình trạng hiện tại của bạn", Toast.LENGTH_LONG).show();
                editTextAddEmail.setError("Bắt buộc chọn tình trạng hiện tại");
                editTextAddEmail.requestFocus();
            } else if (!checkboxcamket.isChecked()) {
                Toast.makeText(AddActivity.this, "Vui lòng chọn cam kết những thông tin khai là đúng sự thật", Toast.LENGTH_LONG).show();
                editTextAddEmail.setError("Bắt buộc chọn cam kết");
                editTextAddEmail.requestFocus();
                ...
                editTextAddEmail.setError("Bắt buộc chọn cam kết");
                editTextAddEmail.requestFocus();
            } else if (TextUtils.isEmpty(textTinhTrang)) {
                Toast.makeText(AddActivity.this, "Vui lòng nhập tình trạng của bạn", Toast.LENGTH_LONG).show();
                editTextAddEmail.setError("Bắt buộc chọn cam kết");
                editTextAddEmail.requestFocus();
            } else {
        ...
        editTextAddDoB.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
    ...
    public void init() {
        ...
        editTextAddDoB = findViewById(R.id.editText_update_patient_dob);
        editTextAddMobile = findViewById(R.id.editText_update_patient_mobile);
        editTextAddCMND = findViewById(R.id.editText_update_patient_passport);
        editAddAddress = findViewById(R.id.editText_update_patient_address);
        editTextAddTinhTrangBenh = findViewById(R.id.editText_update_patient_tinh_trang_benh);
        ...
        radioGroupRegisterGender = findViewById(R.id.radio_group_update_patient_gender);
        radioGroupRegisterGender.clearCheck();

        btnAddPatients = findViewById(R.id.button_add_patient);
        btnExit = findViewById(R.id.button_thoat_patient);
                    ...
                    public void onSuccess(Uri uri) {
                        new Handler().postDelayed(new Runnable() {
                            ...
                            public void run() {
                                ...
                                ReadWritePatientDetails writerPatientDetails = new ReadWritePatientDetails(textFullName, textDoB, textGender, textMobile, textCMND, textEmail, textAddress, Status(), uri.toString(), textTinhTrang);
...
//                                        intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_CLEAR_TASK | Intent.FLAG_ACTIVITY_NEW_TASK);
        ...
        builder.setSingleChoiceItems(items, -1, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                switch (which) {
                    case 0:
                        dialog.dismiss();
                        ActivityCompat.requestPermissions(AddActivity.this, new String[]{Manifest.permission.CAMERA, Manifest.permission.WRITE_EXTERNAL_STORAGE}, REQUEST_CODE_CAMERA);
                        break;
                    case 1:
                        dialog.dismiss();
                        ActivityCompat.requestPermissions(AddActivity.this, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE}, SELECT_PICTURE);
                        break;
                }
            }
        });
    ...
    private void xuLyAnh(Bitmap bitmap) {
        ...
        try {
            Model model = Model.newInstance(AddActivity.this);
